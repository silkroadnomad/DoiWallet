 ...
 * @param toUnit {string} Value from models/doichainUnits.js
 * @param withFormatting {boolean} Works only with `DoichainUnit.SATS`, makes spaces wetween groups of 000
 * @returns {string}
 */
 ...
 *
 * @param balance {number} Satoshis
 * @param toUnit {string} Value from models/doichainUnits.js, for example `DoichainUnit.SATS`
 * @param withFormatting {boolean} Works only with `DoichainUnit.SATS`, makes spaces wetween groups of 000
 * @returns {string}
 */
